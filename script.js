        ...
        if (pedido3 == 5) {
           ...
           Finalizando programa...`)
            ...
            if (estudante == "s" && valorTotal > cinquenta) {
                let calculoDescontoEstudante1 = valorTotal * 10 / 100
                let valorDesconto50 = valorTotal * 5 / 100
                let somaDosDescontos = calculoDescontoEstudante1 + valorDesconto50
                alert(`
                    Obrigado ${nome}!
                    Pratos escolhidos:
                    -  ${comida1} de R$ ${valor1}
                    ...
                    Total com desconto: R$ ${(valorTotal - somaDosDescontos).toFixed(2)}
                    `)
                ...
                alert(`
                    ...
                    -  ${comida3} de R$ ${valor3}
                    Total sem desconto: R$ ${valorTotal}
                    Total com desconto: R$ ${desconto2.toFixed(2)}
                    `)
                alert(`Pedido realizado, obrigado(A) pela prefenrência, volte sempre`)
                ...
                alert(`
                    ...
                    -  ${comida3} de R$ ${valor3}
                    Total sem desconto: R$ ${valorTotal}
                    Total com desconto: R$ ${desconto3.toFixed(2)}
                    `)
                alert(`Pedido realizado, obrigado(A) pela prefenrência, volte sempre`)
            } else if (estudante == "n" && valorTotal <= cinquenta) {
                alert(`
